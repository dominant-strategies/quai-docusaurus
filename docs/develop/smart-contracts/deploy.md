...
- _Access to a Quai node_: you can do this either by [running your own node](../../participate/node/start-a-node/start-a-node.md), accessing a publicly available node, or through API key via a node service.
