...
**Once the SSH connection has loaded, you can follow the** [**Run A Node tutorial**](../start-a-node.md) **and** [**Run a Stratum Proxy tutorial**](../../stratum-proxy/run-stratum.md) **to start your node and proxy.**
