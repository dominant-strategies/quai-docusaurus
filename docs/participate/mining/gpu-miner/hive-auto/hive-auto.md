...
:::danger
Do not start the miner before [confirming your node has fully synced](../../../node/node-faq/node-faq.md). Mining while your node is not synced will result in the mining of **invalid blocks** and **wasted hash**.
:::
